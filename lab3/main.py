...
class Run():
    ...
    def _lowestCost(self):
        print("-----LOWEST COST WALK-----")
        ...
        path_cost, path=self.__Graph.lowest_cost_walk(vertex1,vertex2)
        if path_cost != float('inf'):
            print("Lowest cost walk from " + str(vertex1)+ " to "+str(vertex2)+" is: "+str(path_cost))
            print("Walk: ",end=' ')
            print(*path,sep="->")
        else:
            print("No walk from "+str(vertex1)+" to "+str(vertex2)+"!!!!!")
